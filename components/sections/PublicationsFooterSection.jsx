          ...
          <div className={styles.mobileLayout}>
            ...
            {profile.phone && (
              <div className={styles.mobilePhone}>
                <a href={`tel:${profile.phone}`} className={styles.mobilePhoneLink}>
            ...
            <div ref={leftRef} className={styles.leftCol}>
              ...
              <div className={styles.footerInfo}>
                ...
                <div className={styles.contactRow}>
                  ...
                  {profile.phone && (
                    <a href={`tel:${profile.phone}`} className={styles.footerPhone}>
                      <FaPhone size={12} />
                      {profile.phone}
                    </a>
                  )}
          ...
          <div ref={bottomBarRef} className={styles.bottomBar}>
            <div className={styles.bottomLeft}>
              <div className={styles.monogram}>
                <span className={styles.monoLetters}>AD</span>
